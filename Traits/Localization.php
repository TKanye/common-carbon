...
namespace utils\Carbon\Traits;

use utils\Carbon\CarbonInterface;
use utils\Carbon\Exceptions\InvalidTypeException;
use utils\Carbon\Exceptions\NotLocaleAwareException;
use utils\Carbon\Language;
use utils\Carbon\Translator;
use utils\Carbon\TranslatorStrongTypeInterface;
use Closure;
use utils\Carbon\Symfony\Translator\TranslatorBagInterface;
use utils\Carbon\Symfony\Translator\LocaleAwareInterface;
...
trait Localization
{
     ...
     * @param \Symfony\Translator\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
