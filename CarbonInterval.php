...
namespace utils\Carbon;

use utils\Carbon\Exceptions\BadFluentConstructorException;
use utils\Carbon\Exceptions\BadFluentSetterException;
use utils\Carbon\Exceptions\InvalidCastException;
use utils\Carbon\Exceptions\InvalidFormatException;
use utils\Carbon\Exceptions\InvalidIntervalException;
use utils\Carbon\Exceptions\OutOfRangeException;
use utils\Carbon\Exceptions\ParseErrorException;
use utils\Carbon\Exceptions\UnitNotConfiguredException;
use utils\Carbon\Exceptions\UnknownGetterException;
use utils\Carbon\Exceptions\UnknownSetterException;
use utils\Carbon\Exceptions\UnknownUnitException;
use utils\Carbon\Traits\IntervalRounding;
use utils\Carbon\Traits\IntervalStep;
use utils\Carbon\Traits\LocalFactory;
use utils\Carbon\Traits\MagicParameter;
use utils\Carbon\Traits\Mixin;
use utils\Carbon\Traits\Options;
use utils\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
use DateTime;
...
use utils\Carbon\Symfony\Translator\TranslatorInterface;
use Throwable;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     * code including the third-party dependencies that also may use utils\Carbon will
