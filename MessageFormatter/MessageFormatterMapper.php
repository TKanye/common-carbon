...
namespace utils\Carbon\MessageFormatter;
...
require $transMethod->getParameters()[0]->hasType()
    ? __DIR__.'/../LazyMessageFormatter/MessageFormatterMapperStrongType.php'
    : __DIR__.'/../LazyMessageFormatter/MessageFormatterMapperWeakType.php';
